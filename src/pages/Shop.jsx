import React, { useState, useEffect, useRef, useContext } from 'react';
    ...
    function Shop() {
      ...
      const [products, setProducts] = useState([
        { id: 9, name: 'Tribal Hoodie', price: '$179', category: 'Tops', image: 'https://i.ibb.co/jrBdNkJ/Oversized-punk-devil-design-print-hoodies-women-y2k-tops-goth-streetwear-harajuku-sweatshirt-hoodie.jpg', htmlId: 'tribal-hoodie', sizes: ['S', 'M', 'L', 'XL'], colors: ['Black', 'Gray'] },
        { id: 10, name: 'Black Widow Hoodie', price: '$229', category: 'Tops', image: 'https://i.ibb.co/qdqqfgT/growlxxstudios-on-ig-1.jpg', sizes: ['S', 'M', 'L', 'XL'], colors: ['Black', 'Red'] },
        { id: 11, name: 'Tribal Jacket', price: '$349', category: 'Outerwear', image: 'https://i.ibb.co/QN8Prwr/download-20.jpg', sizes: ['S', 'M', 'L', 'XL'], colors: ['Black', 'Brown'] }
      ]);
